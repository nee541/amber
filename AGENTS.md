...
The app should use a "Soft Bento Productivity" visual style.

Principles:
- Clean, modern desktop productivity app aesthetic.
- Light theme by default, with warm gray background and white card surfaces.
- Use Bento-style card layouts for overview pages.
- Prefer large rounded cards, subtle borders, soft shadows, and calm spacing.
- Use one primary accent color only, preferably soft blue-purple.
- Use semantic colors only for item status: success, warning, danger.
- Avoid heavy gradients, excessive glassmorphism, neumorphism, cyberpunk visuals, or noisy decoration.
- Prioritize readability, hierarchy, and maintainability over pixel-perfect decorative UI.

Layout:
- Left sidebar navigation.
- Main content area with top search/action bar.
- Dashboard-style overview cards.
- Item list and item detail pages should use card-based layouts.

Visual tokens:
- App background: #F7F7F5
- Card background: #FFFFFF
- Muted surface: #F1F2EF
- Border: #E6E6E1
- Primary text: #202124
- Secondary text: #6B6F76
- Primary accent: #6D8DFF
- Primary soft background: #E8EDFF
- Border radius for cards: 20px
- Border radius for buttons/inputs: 12px
- Shadow: 0 8px 24px rgba(15, 23, 42, 0.06)

Typography:
- Use system fonts, Inter, SF Pro, PingFang SC.
- Page title: 24px, semibold.
- Card title: 15px, semibold.
- Body text: 14px.
- Helper text: 12px.
- Important numbers: 28px, semibold.

Interaction:
- Cards may have subtle hover states.
- Buttons should have simple pressed states.
- Page transitions should be short and restrained.
- Do not introduce complex animation libraries unless necessary.
